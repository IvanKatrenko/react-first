...
export const Navigation = () => (
    <nav className={s.navigation}>
        <a className={s.link} href="/favorite">
            <span className={s.text}>Favorities</span>
        ...
        <a className={s.link} href="/cart">
            <span className={s.text}>Basket</span>
            ...
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.87336 1.33325L3.46002 3.75325" stroke="#1C1C1C"
                    strokeMiterlimit="10"
                    strokeLinecap="round" strokeLinejoin="round" />
                <path d="M10.1266 1.33325L12.54 3.75325" stroke="currentColor"
                    strokeMiterlimit="10"
                    strokeLinecap="round" strokeLinejoin="round" />
                <path
                    ...
                    stroke="currentColor" />
                <path
                    d="M6.50665 9.33325V11.6999" stroke="#currentColor" strokeLinecap="round" />
                <path
                    d="M9.5733 9.33325V11.6999" stroke="#currentColor" strokeLinecap="round" />
                <path
